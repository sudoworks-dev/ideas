...
**Die Motivation ist nicht naiv. Die erwartete Größenordnung ist es.**
...
Der bestehende 10-Std.-Job liegt in denselben Vormittagen und findet in München statt. Was davon übrig bleibt:
...
## Die rechtliche Decke

Das Heilpraktikergesetz erfasst **jede berufsmäßige Tätigkeit zur Feststellung, Heilung oder Linderung von Krankheiten oder Leiden**. Heilkunde ohne Erlaubnis auszuüben ist eine Straftat — strafbar auch ohne Schaden.

**Die Trennlinie:** Über heilkundliche Themen allgemein informieren ist erlaubt. Diese Kenntnisse **auf eine einzelne Klientin mit Beschwerden anzuwenden** ist verboten. Ein Haftungsausschluss im Kleingedruckten ändert daran nichts.

**Warum das genau hier trifft:** „Hormoncoaching" und „ganzheitliches Endometriose-Coaching" werden in der Fachliteratur namentlich als Problemfälle genannt. Die Modulliste des Kurses besteht fast vollständig aus Beschwerdebildern — deren individuelle Einordnung ist der Kaufgrund und zugleich die verbotene Handlung.

**Schon die Werbung genügt:** Ein Gericht hat einem Friseur die Bewerbung einer „Haarsprechstunde bei Haarausfall" untersagt, obwohl er gar keine Heilkunde ausübte — es reichte der erweckte Eindruck.
...
| Verweis an Ärztin / Heilpraktikerin | Symptombezogene Empfehlung von Nahrungsergänzung |
| „Beraterin", „Coach" (nicht geschützt) | „Therapeutin", alles mit ärztlicher Anmutung |
| Sachliche Leistungsbeschreibung | Erfolgsgeschichten, Vorher-Nachher, Heilversprechen |

Dazu: Sie ist keine Berufsgeheimnisträgerin, deshalb braucht jede Verarbeitung von Gesundheitsdaten die ausdrückliche Einwilligung, und ein Verarbeitungsverzeichnis ist ab der ersten Klientin Pflicht.
...
- **„Frauengesundheit" ist kein anerkanntes Handlungsfeld** der Prävention. Es gibt genau vier (Bewegung, Ernährung, Stressmanagement, Suchtmittel) — abschließend.
- Die Kassen-Bezuschussung nach § 20, § 20b und § 43 SGB V entfällt damit komplett.
- Auch das steuerliche Firmen-Argument (§ 3 Nr. 34 EStG, 600 €/Mitarbeiter steuerfrei) **greift nicht** — es verlangt dieselbe fehlende Zertifizierung. Firmen können solche Workshops bezahlen, aber nur als normale Betriebsausgabe.
...
Das **MFM-Projekt® („Die Zyklus-Show")** ist exakt dieses Produkt: Mädchen der 5./6. Klasse, ein ganzer Schulvormittag. Entwickelt 1999 in der Erzdiözese München-Freising (Dachaus eigener Diözese), getragen von den bayerischen Diözesen, mit über 300 ausgebildeten Mitarbeiterinnen.

| | |
|---|---|
| Honorar | ~180 € je Workshop für einen ganzen Vormittag ≈ 30–40 €/Std. |
| Bezahlt von | häufig den Eltern pro Kind, sonst Förderverein |
| Kaufgrund der Schule | Empfehlung der Nachbarschule und ein erprobtes Programm — nicht die Gestaltung des Handouts |

> Wenn dieses Segment reizt, ist der billigste Weg hinein die **MFM-Multiplikatorinnenausbildung** — ein eingeführter Kanal mit Material, Elternabend-Format und Mundpropaganda unter Lehrkräften, ohne eigenen Vertrieb. **Das könnte der bessere Kauf sein als der AKN-Kurs.** Zu prüfen ist die weltanschauliche Passung — das Programm ist kirchlich getragen.
>
> Die Buchgestaltung ist hier kein Burggraben, sondern eine kleine Kostenersparnis und ein Qualitätsvorsprung beim Material.

### Betriebliche Gesundheitsförderung — später, kein Einstieg

Passt zwar ins Zeitfenster, trägt aber nicht als Start: das Steuer-Argument existiert nicht, kein Anbieter nennt öffentlich einen Preis (Zeichen eines dünnen Marktes), und die Vertriebszyklen dauern 6–18 Monate. Der gesellschaftliche Rückenwind zum Thema Wechseljahre am Arbeitsplatz ist echt — in zwei Jahren vielleicht ein guter Kanal, heute nicht.

### Heilpraktiker-Vollprüfung — die einzige Option, die die Decke entfernt

Prüfung beim Gesundheitsamt, ~700–1.000 € je Durchgang, Bestehensgrenze 75 %, üblich 1,5–3 Jahre Vorbereitung. **Beseitigt die rechtliche Decke — als einziger Weg.** Beseitigt die ökonomische nicht (Durchschnitts-Heilpraktiker: 21.000–32.000 € Umsatz). Reihenfolge: erst Nachfrage belegen, dann investieren.
...
**20 Gespräche** mit Frauen aus der Zielgruppe:

- *Wofür hast du in den letzten zwölf Monaten im Bereich Gesundheit **tatsächlich Geld ausgegeben** — und wie viel?*
...
**Plus fünf kurze Anrufe:**

1. Zwei Dachauer Schulen: Arbeitet ihr mit dem MFM-Projekt? Wer bezahlt das?
